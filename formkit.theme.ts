...
/**
  ...
  *
  * @checksum - 97ee4c764e53b19faa3effe05ba2e77b853d5f32caf66467c7ca8352e92d1e15
  * @variables - radius=rounded,accentColor=blue,colorTemperature=neutral,spacing=1.5,scale=base,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
